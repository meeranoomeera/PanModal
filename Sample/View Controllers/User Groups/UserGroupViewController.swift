...
class UserGroupViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, PanModalPresentable {
	...
	override func viewDidLoad() {
		...
		NSLayoutConstraint.activate([
			textField.topAnchor.constraint(equalTo: bottomContainer.topAnchor, constant: 20),
			textField.leadingAnchor.constraint(equalTo: bottomContainer.leadingAnchor, constant: 20),
			textField.trailingAnchor.constraint(equalTo: bottomContainer.trailingAnchor, constant: -20),
			textField.bottomAnchor.constraint(equalTo: bottomContainer.bottomAnchor, constant: -40)
		])
